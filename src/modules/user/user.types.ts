...
import { createUserSchema, updateAccountStatusSchema, getAllUsersQuerySchema } from "./user.schema";
import z from "zod";
...
export type { TUserRole, TAccountStatus, TCreateUserPayload, TUpdateAccountStatusPayload, TGetAllUsersQuery };
export { USER_ROLE };